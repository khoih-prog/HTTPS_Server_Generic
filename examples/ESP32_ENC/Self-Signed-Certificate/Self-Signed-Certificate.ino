/**
   ...
   generated on the ESP32_ENC, so you do not need to provide them here.
...
void setup()
{
  ...
  //   entry pointing to your ESP32_ENC. You can try to insert an IP there, but that's not really good style.
