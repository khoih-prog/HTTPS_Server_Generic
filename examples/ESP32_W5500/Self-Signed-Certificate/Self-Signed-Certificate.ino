/**
   Example for the ESP32_W5500 HTTP(S) Webserver
   ...
   generated on the ESP32_W5500, so you do not need to provide them here.
...
void setup()
{
  ...
  //   entry pointing to your ESP32_W5500. You can try to insert an IP there, but that's not really good style.
