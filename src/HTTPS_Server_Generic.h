...
#define HTTPS_SERVER_GENERIC_VERSION            "HTTPS_Server_Generic v1.2.0"

#define HTTPS_SERVER_GENERIC_VERSION_MAJOR      1
#define HTTPS_SERVER_GENERIC_VERSION_MINOR      2
#define HTTPS_SERVER_GENERIC_VERSION_PATCH      0

#define HTTPS_SERVER_GENERIC_VERSION_INT        1002000
